export function clientVendorBidDataMailText (user){
...
<head>
   ...
   <style type="text/css">
      ...
      #service {
         /*@editable*/
         background-color: #5fb0e5 !important;
         /*@editable*/
         color: #000 !important;
      }
      ...
      #paravideo {
         /*@editable*/
         background-color: #99ce00 !important;
         /*@editable*/
         color: #000 !important;
      }
...
<body
   style="width:100% !important; color:#292c30; background:#F8F7FA; font-family: 'Raleway', sans-serif; font-size:14px; line-height:20px;"
               ...
               <tr>
                  <td style="padding-left:20px; padding-right:20px; background:#ffffff;">
                     <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                           <td
                              style="font-weight:400;font-size: 14px; line-height: 20px; color:#344054;font-family: 'Raleway', sans-serif;">
                              Dear User,
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td
                              ...
                              A new bid has been made by a vendor for your trip. Please check attached pdf for the same.
                           </td>
                        </tr>
                        <tr>
                           <td height="15"><img src="images/spacer.gif" width="1" height="1" alt="" /></td>
      ...
      <tr>
         <td style="background: #F8F7FA; padding-left: 20px; padding-right:20px" id="footertop">
            <table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
               ...
               <tr>
                  <td
                     style="color:#475467;font-family: 'Raleway', sans-serif; font-size: 12px; line-height:20px;text-align:left;font-weight:400">
                     Best regards, <br />
                     GAC
                  </td>
               </tr>
               ...
               <tr>
                  <td>
                     <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                        <tr>
                           <td><a href="#" target="blank"><img src="images/logo.png" width="50" height="" alt="" /></a>
                           </td>
