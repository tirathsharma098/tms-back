export function tokenForTripClientReview (reset_password_link, client){
                      ...
                      <tr>
                         ...
                         <tr>
                                  <td style="font-weight:400;font-size: 14px; line-height: 20px; color:#344054;font-family: 'Raleway', sans-serif;">
                                     ...
                                     We kindly request you to leave a review for your recent trip by following the link below. Your time is greatly appreciated, and your feedback is invaluable to us.
      </td>
                               </tr>
                         <tr>
                                  <td height="15"><img src="images/spacer.gif" width="1" height="1" alt="" /></td>
