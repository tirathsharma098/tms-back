export function invitePasswordEmployeeMailTemplate (reset_password_link, user){
                      ...
                      <tr>
                         ...
                         <tr>
                                  <td style="font-weight:400;font-size: 14px; line-height: 20px; color:#344054;font-family: 'Raleway', sans-serif;">
                                     ...
                                     We are pleased to invite you to set up your account on GAC. Kindly follow the link below to create your GAC login password.
      </td>
                               </tr>
                               <tr>
                                  <td>
