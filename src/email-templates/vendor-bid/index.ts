export function vendorBidEmailTemplate (verification_link){
                     ...
                     <tr>
                        ...
                        <tr>
                                 <td style="font-weight:400;font-size: 14px; line-height: 20px; color:#344054;font-family: 'Raleway', sans-serif;">
                                    ...
                                    You have been kindly requested to provide the pricing details for the quote referenced below. Kindly fill in only the fields corresponding to the vehicles you currently possess.
     </td>
                              </tr>
                        <tr>
                                 <td height="15"><img src="images/spacer.gif" width="1" height="1" alt="" /></td>
                        ...
                        <tr>
                              ...
                              <tr>
                                 ...
                                 <a href="${verification_link}" style="border: 1px solid #5980b6 !important;border-radius: 8px;color:#fff; display: inline-block; border-radius:8px; -webkit-border-radius:8px; line-height:34px; width: 160px; text-decoration: none;font-size:12px;" >Click Here</a></td>
                              </tr>
                                    </table>
